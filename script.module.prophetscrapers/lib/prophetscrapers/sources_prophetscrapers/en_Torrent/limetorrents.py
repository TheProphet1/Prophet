    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            if 'tvshowtitle' in data:
                url = self.tvsearch.format(urllib.parse.quote(query))
            else:
                url = self.moviesearch.format(urllib.parse.quote(query))
    ...
    def _get_items(self, url):
        try:
            ...
            for post in posts:
                ...
                link = urllib.parse.urljoin(self.base_link, data.attrs['href'])
                name = data.content
