...
import re, urllib.request, urllib.parse, urllib.error, urllib.parse, json, traceback
...
class source:
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            url = urllib.parse.urljoin(self.base_link, self.search_link % urllib.parse.quote_plus(query))
