...
import re, urllib.request, urllib.parse, urllib.error, urllib.parse, json

from prophetscrapers.modules import cleantitle
from prophetscrapers.modules import client, source_utils
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['watchepisodes.com', 'watchepisodes.unblockit.dev']
    ...
    def sources(self, url, hostDict, hostprDict):
        ...
        try:
            ...
            query = urllib.parse.quote_plus(cleantitle.getsearch(title))
            surl = urllib.parse.urljoin(self.base_link, self.search_link % query)
            ...
            for i in r:
                ...
                slink = i['seo']
                slink = urllib.parse.urljoin(self.base_link, slink)
