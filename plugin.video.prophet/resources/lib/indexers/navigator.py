...
class navigator:
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem('[COLOR yellow]More IMDb Keywords[/COLOR]', 'movieKeywords2', 'imdb.png', 'DefaultMovies.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem('[COLOR yellow][B]Prophet[/B] : Cache Functions[/COLOR]', 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[COLOR yellow][B]Prophet[/B] : Log Functions[/COLOR]', 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
