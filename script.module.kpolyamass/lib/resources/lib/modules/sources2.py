...
#TC 2/01/19 started
        ...
        if control.addonInfo('id') == 'plugin.video.kpolyamass':
            try:
                ...
                if quality == 'AUTO':
                    ...
                    control.window.clearProperty("plugin.video.kpolyamass.container.items")
                    control.window.setProperty("plugin.video.kpolyamass.container.items", json.dumps(items))

                    control.window.clearProperty("plugin.video.kpolyamass.container.meta")
                    control.window.setProperty("plugin.video.kpolyamass.container.meta", meta)
                    control.window.clearProperty(self.itemProperty)
                    control.window.setProperty(self.itemProperty, json.dumps(items))
    ...
    def sourcesFilter(self):
        ...
        sortkpolyamass = control.setting('torrent.sort.kpolyamass')
        if sortkpolyamass == '':
            sortkpolyamass = 'false'
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.kpolyamass.container.items'
