...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'Kpolyamass Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.kpolyamass')
    ...
    try:
        curVersion = control.addon('script.module.kpolyamass').getAddonInfo('version')
