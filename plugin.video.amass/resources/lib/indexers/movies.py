...
class movies:
        def __init__(self):
                ...
                if self.tmdb_key == '' or self.tmdb_key == None:
                        self.tmdb_key         = base64.b64decode('NjgxMjg0NTFkOTIxZmYzYjdmMWI3NjEwYjNjYmVhZDA=')
        ...
        def movieDirectory(self, items):
                ...
                for i in items:
                        try:
                                ...
                                if "tt" in imdb                     : sysmetalliq = "plugin://plugin.video.metalliq/movies/add_to_library_parsed/imdb/%s/direct.amass.q" % imdb
                                elif not tmdb == "0" or tmdb == None: sysmetalliq = "plugin://plugin.video.metalliq/movies/add_to_library_parsed/tmdb/%s/direct.amass.q" % tmdb
                                else                                : sysmetalliq = "0"
