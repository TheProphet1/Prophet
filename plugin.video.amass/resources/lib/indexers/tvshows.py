...
class tvshows:
    def __init__(self):
        ...
        self.tvdb_key             = base64.urlsafe_b64decode('NzVSVlJQUVpYNVFHRUVDUQ==')
    ...
    def tvshowDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                if not tvdb == "0" or tvdb == None: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.amass.q" % tvdb
                elif "tt" in imdb: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.amass.q" % imdb
                else: sysmetalliq = "0"
