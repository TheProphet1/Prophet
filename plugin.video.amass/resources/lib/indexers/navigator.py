...
sysaddon         = base64.b64decode('cGx1Z2luOi8vcGx1Z2luLnZpZGVvLmFtYXNzLw==')
...
class navigator:
        def root(self):
             ...
             #   self.addDirectoryItem('My Amass',       'lists_navigator',      'mymovies.png',      'DefaultRecentlyAddedMovies.png')
...
#		self.addDirectoryItem('Trending',          'movies&url=trending',   'trending.png',      'DefaultRecentlyAddedMovies.png')
        ...
        def tools(self):
                ...
                self.addDirectoryItem('[B]AMASS[/B]: Views', 'viewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]AMASS[/B]: Clear Providers', 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]AMASS[/B]: Clear Cache', 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem('[B]AMASS[/B]: Clear Progress Database', 'clearProgress', 'tools.png', 'DefaultAddonProgram.png')
                self.endDirectory()
